...
slimCommand=$slimCommand' -d RUNTIME=168'};
...
#add output stem
outputStem="sc2-full2_"$modelNum"."$reqdNumOut"."${paramSel[1]}"."${paramSel[2]}"."${paramSel[3]}"."${paramSel[4]};
